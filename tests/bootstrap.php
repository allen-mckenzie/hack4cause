 ...
 * @since 0.0.1
 */
function _manually_load_hack4cause_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/hack4cause.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_hack4cause_plugin' );
